...
public class ClickhouseReader extends Reader {
    ...
    public static class Job extends Reader.Job {
        ...
        public void init() {
            ...
            this.commonRdbmsReaderJob = new SubCommonClickhouseReader.Job(
                    DATABASE_TYPE);
    ...
    public static class Task extends Reader.Task {
        ...
        public void init() {
            ...
            this.commonRdbmsReaderTask = new SubCommonClickhouseReader.Task(DATABASE_TYPE,super.getTaskGroupId(),super.getTaskId());
